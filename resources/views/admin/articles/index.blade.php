			...
			<table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Employee">
				...
				<tbody>
					...
					<tr>
						...
						<a class="btn btn-success btn-sm" href="{{ route('admin.articles.edit',$row->id) }}"><i class="fa fa-edit"></i></a>
						<form method="post" action="{{ route('admin.articles.destroy',$row->id) }}" class="d-inline">
						@csrf
						@method("delete")

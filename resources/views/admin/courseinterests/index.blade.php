	...
	<div class="card">
		...
		<div class="card-body">
			<table class="table table-bordered table-striped table-hover ajaxTable datatable datatable-Employee" id="spTable">
				...
				<tbody>
					@foreach($courseinterests as $key=>$row)
					<tr>
...
<script>
  ...
  submitHandler: function(form) {
   ...
   var rechargeform = document.getElementById('edit-form');
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo url('admin/courseinterests/remark_process'); ?>",
        data: fd,
        contentType: false,           
        processData:false, 

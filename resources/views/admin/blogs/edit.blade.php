			...
			<form action="{{ route("admin.blogs.update",$blog->id) }}" method="POST" enctype="multipart/form-data">
				<div class="row">
					...
					<div class="col-md-12 form-group">
						<label>Content</label>
						<textarea class="ckeditor form-control" name="description">{{ old('content',$blog->content)}}</textarea>
					</div>
					...
					<div class="col-md-6 form-group {{ $errors->has('thumbnail') ? 'has-error' : '' }}">
						...
						<?php if($blog){?>
							<a href="{{asset('uploads/blog/'.$blog->thumbnail)}}" target="_blank"><img src="{{asset('uploads/blog/'.$blog->thumbnail)}}" width="80" style="margin-top: 10px;float: right;"></a>
						<?php } ?>	
					</div>
					...
					<div class="col-md-6 form-group {{ $errors->has('blog') ? 'has-error' : '' }}">
						...
						<?php if($blog){?>
							<a href="{{asset('uploads/blog/'.$blog->image)}}" target="_blank"><img src="{{asset('uploads/blog/'.$blog->image)}}" width="80" style="margin-top: 10px;float: right;"></a>
						<?php } ?>	
					</div>
					...
					<div class="col-md-6 form-group {{ $errors->has('publish_date') ? 'has-error' : '' }}">
						...
						<input type="text" id="publish_date" name="publish_date" class="form-control" value="{{ old('publish_date',$blog->publish_date) }}" required >
					...
					<div class="col-md-12 form-group">
						...
						<textarea class="form-control" name="meta_title" rows="2">{{ old('meta_title',$blog->meta_title)}}</textarea>
					</div>
					...
					<div class="col-md-12 form-group">
						...
						<textarea class="form-control" name="meta_keywords" rows="2">{{ old('meta_keywords',$blog->meta_keywords)}}</textarea>
					</div>

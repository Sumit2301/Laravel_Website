...
<meta property="og:site_name" content="My Medical Course">
<meta property="og:title" content="{{ $college->name }}">
<meta property="og:description" content="{{ $city_name }}, {{ $state_name }}">
<meta property="og:image" content="{{ asset('uploads/logo/').'/'.$college->logo }}">
<meta property="og:image:width" content="300">
<meta property="og:image:height" content="300">
<meta property="og:url" content="https://mymedicalcourse.com/college/{{ $college->url }}">
@endsection
...
.college-image{ width:100% !important; }
</style>
@endsection
...
<?php /* ?>
        ...
        <!-- Courses & Fee -->
        <div id="course-fee" class="section-heading mt-5">Courses & Fee</div>
        ...
        @if(!empty($college->cutoff) && $college->cutoff->description)
        <!-- Cutoff -->
        <div id="cutoff" class="section-heading mt-2">Cutoff</div>

        <div class="section-feedback row m-0 p-0">
            <div class="learn-col">
                  {!! !empty($college->cutoff) ? $college->cutoff->description : '' !!}
        ...
        @if(!empty($college->admission) && $college->admission->description)
        <!-- Admission -->
        <div id="admission" class="section-heading mt-2">Admission</div>

        <div class="section-feedback row m-0 p-0">
            <div class="learn-col">
                  {!! !empty($college->admission) ? $college->admission->description : '' !!}
        ...
        @if(!empty($college->facilities))
        <!-- Facilities -->
        <div id="facilities" class="section-heading mt-2">Facilities</div>

        <div class="section-feedback row m-0 p-0">
            <div class="learn-col">
                  {!! !empty($college->facilities) ? $college->facilities : '' !!}
        ...
        @if(!empty($college->placement) && $college->placement->description)
        <!-- Placements -->
        <div id="placements" class="section-heading mt-2">Placements</div>

        <div class="section-feedback row m-0 p-0">
            <div class="learn-col">
                  {!! !empty($college->placement) ? $college->placement->description : '' !!}
        ...
        @if(count($news)>0)
        <!-- News -->
        <div id="news" class="section-heading mt-2">News</div>
        ...
        <!-- Photos -->
        <div id="photo" class="section-heading mt-2">Photos</div>

        <div class="gallery section-feedback row mt-0 mb-0 pt-0">
        ...
        <!-- Videos -->
        <div id="videos" class="section-heading mt-2">Videos</div>
...
<?php /* ?>
        ...
        <div class="section-heading mt-4">Feedback</div>
        <div class="section-feedback row m-0 p-0">
    ...
    @include('nepal.college_details_sidebar')
</div>
  </section>
          ...
          <div class="swiper-slide">
            <div class="single-college-card">
              ...
              <div class="row m-0 p-0 location-ownership">
                @if($city_name)
                <div class="location"><i class="fas fa-map-marker-alt"></i> {{ $city_name }}</div>
                @endif

...
<meta property="og:image" content="{{  asset('public/front') }}/w.jpg" />
...
.limit-1 {
 ...
 @media(max-width:992px){
    ...
    .md-show{ display:grid !important; }
...
<div class="nav-div college-all-div">
    <nav class="navbar navbar-expand-lg container page-navbar navbar-light">
        <div class="navbar-logo">
         <a href="{{ url('/') }}"><img src="{{ asset('assets/site') }}/images/logo1.jpg" alt="" srcset="" width="100px"></a>
        </div>
        ...
        <div class="row m-0 p-0">
            <div class="col-md-12">
              ...
              <li class="nav-item nav-dropdown">
                ...
                <h2 class="header-heading mt-2 text-center">MBA colleges in India</h2>      
...
<div class="nav-div ">
    ...
    <nav class="navbar navbar-expand-lg container page-navbar navbar-light sticky-header">
        <div class="navbar-logo">
         <a href="{{ url('/') }}"><img class="sitelogo" src="{{ asset('assets/site') }}/images/logo1.jpg" alt="" srcset=""></a>
        </div>
        <div class="md-show">
            <a href="tel:+911234567890" class="btn btn-primary signupButton">+91 1234567890</a>
            <!--<a href="tel:+911234567890" class="btn btn-primary signupButton">+91 1234567890</a>-->
        </div>
    ...
    <span class="navbar-toggler-icon"></span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto navbar-customize-menu">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('courses') }}">Courses <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ url('exams') }}">Exams <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
            ...
            <!--<li class="nav-item">-->
            <!--    <button type="button" data-toggle="modal" data-target="#signUpModal" style="background:transparent; border:0;"><span class="nav-link">Sign Up</span></button>-->
            <!--   <span class="sr-only">(current)</span>-->
            <!--</li>-->
          </ul>
          <ul class="navbar-nav navbar-customize-menu topmob">
            <li><a href="tel:+1234567890" class="btn  signupButton"><img src="{{ asset('assets/site') }}/images/phone.gif" alt="" width="30px">+91 1234567890 </a></li>
            <!--<li><a href="tel:+1234567890" class="btn btn-primary signupButton">+91 1234567890</a></li>-->
          </ul>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="assets/site/images/banner01.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="assets/site/images/banner01.png" alt="Second slide">
    </div>
      ...
      <header class="container">
        <div class="row m-0 p-0">
            <div class="col-md-12 header-left">
                <!--<div class="row heading">Your Dream of MBA College is Fulfilled Here <span>&nbsp; MBA</span></div>-->
            </div>
 ...
 <div class="container">
   <div class="row p-0 m-0 footer-logo-section">
     <div class="col-md-5 footer-logo">
       <img src="{{ asset('assets/site') }}/images/logo1.jpg" alt="">
       <h4 class="mt-3">My MBA Course</h4>
     </div>
  ...
  <div class="row p-0 m-0">
    <div class="col-md-3 col-6">
      <ul class="footer-menu-links">
        ...
        <li><a href="{{ url('blogs') }}">MBA Courses Blogs</a></li>
      </ul>
    </div>
    <div class="col-md-3 col-6" >
      <ul class="footer-menu-links">
    ...
    <div class="col-md-3 col-6">
      <ul class="footer-menu-links">
        ...
        <li><a href="tel:+91 1234567890">1234567890</a>, <a href="tel:+91 1234567890">1234567890</a>, <a href="tel:+91 1234567890">1234567890</a>, <a href="tel:+91 1234567890"></a></li>
        <li></li>
      </ul>
    </div>
  </div>
...
<div class="modal fade" id="enquiry" tabindex="-1" role="dialog" aria-labelledby="enquiryModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        <form method="post" action="{{ url('banner-form') }}">
                        ...
                        <div class="col-md-12">
							...
							<input class="form-check-input" type="checkbox" name="agree" value="yes" required="">
						    <details>
                            <summary class="form-check-label limit-1">I, hereby authorize mba.. </summary>
...
<!--    <a href="{{ route('student-neet-signup-form') }}" class="nav-link p-0">College Predictor</a>  -->
<!--</div> -->

<!--<div class="snews" onclick="showNewsletter()">-->
<!--  Subscribe  Newsletter-->
<!--</div>-->
<div class="enq" onclick="showEnquiry()">
 Enquiry Now <img src="{{asset('assets/site/images/arrow-gif.gif')}}" alt="" class="arrow-gif">
</div>

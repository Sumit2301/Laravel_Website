...
namespace App\Http\Controllers\Frontend\Nepal;
...
class NepalController extends Controller
{
    ...
    public function nepal()
    {
        ...
        return view('nepal.nepal', compact('colleges','exams','examsall','course_list','state', 'state_list', 'courses','blogs','default_course_url','course','course_detail','rank_data','option','articles','ebooks','videos'));
    }
    # End nepal
	...
	public function videos(Request $request)
    {
        ...
        return view('nepal.youtube_videos', compact('videos'));
	}
	...
	public function contact_us(Request $request)
    {
		$exams = Exam::select('*');
		$exams = $exams->Paginate(12);
        return view('frontend.contact_us', compact('exams'));
	}

...
class NepalCollegeController extends Controller
{
	...
	public function details($url)
    {
        ...
        return view('nepal.college', compact('college','exams','reviews','avg_stars','avg_stars1','avg_stars2','avg_stars3','avg_stars4','avg_stars5',
	...
	public function news($url,$news_url){
		...
		$news = News::where('news.college_id',$college->id)->where('news.slug',$news_url)
			->first();
		$exams = Exam::get();
		return view('nepal.news_detail', compact('news','college','exams','college_tab')); 
	}

...
class CollegeController extends Controller
{
	...
	public function details($url)
    {
        ...
        return view('frontend.college', compact('college','exams','reviews','avg_stars','avg_stars1','avg_stars2','avg_stars3','avg_stars4','avg_stars5','count_stars1','count_stars2','count_stars3','count_stars4','count_stars5','total','colleges','collegevideos','college_tab'));
		//return College::with('cityname')->get();
    }

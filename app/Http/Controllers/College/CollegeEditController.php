...
// 		$search_key_arr["city"] = $city[0];
	...
	public function edit($id,$option='',$id2='')
    {
		...
		if($option == 'blog'){			
			...
			return view('college_panel.colleges.edit_college', compact('college','id','news'));
		}
			...
			return view('college_panel.colleges.admission_process', compact('college','id','data'));
		}
			...
			return view('college_panel.colleges.course_fee', compact('college','id','courses','exams'));
			...
			return view('college_panel.colleges.cutoff', compact('college','id','data'));
		}
			...
			return view('college_panel.colleges.placement', compact('college','id','data'));
		}
			...
			return view('college_panel.colleges.photos', compact('college','id','data'));
		}
			...
			return view('college_panel.colleges.blogs', compact('college','id','news','editnews','uid'));
		} 
			...
			return view('college_panel.colleges.videos', compact('college','id','news','collegevideo','uid'));
		}
			...
			return view('college_panel.colleges.reviews', compact('college','id','news','collegereview','uid'));
		}
		else {
			$states = State::all()->pluck('state_name', 'id');
			$college = College::find($id);
			if(isset($college->id) && $college->id > 0){
				...
				return view('college_panel.colleges.edit_college', compact('states','college','id','courselist','ranktypelist','college_course_detail','tblrank'));
